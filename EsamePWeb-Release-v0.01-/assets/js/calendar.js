...
modalCalendario.addEventListener('show.bs.modal', () => {
  ...
  //Fetch
  fetch('assets/php/get_prenotazioni.php',{
    method : 'POST',
    headers : {'Content-Type': 'application/x-www-form-urlencoded'},
  ...
  function updateSlots(selDate){
    ...
    const intervals = EXCEPTIONS[ymd] || [];            // lista intervalli della data
    const times = buildTimes(BUSINESS_HOURS);           // i tuoi slot generati
