...
function aggiungiAlCarrello(prodottoId, utente_cf) {
    fetch('/../EsamePWeb/backend/aggiungi_carrello.php', {
        method: 'POST',
...
function aggiornaBadgeCarrello(utente_cf) {
  fetch('/../EsamePWeb/backend/conteggio_carrello.php', {
      method: 'POST',
      headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
      body: new URLSearchParams({
          utente_id: utente_cf
...
function svuota(){
  const utente_cf = document.querySelector('.cart-badge')?.dataset.utente;
  fetch('/../EsamePWeb/backend//svuota_carrello.php',{
    method: 'POST',
    headers: {'Content-Type': 'application/x-www-form-urlencoded' },
...
function acquistaCarrello() {
  ...
  fetch('/../EsamePWeb/backend//acquista.php', {
    method: 'POST',
    headers: { 'Content-Type': 'application/x-www-form-urlencoded' },
    body: new URLSearchParams({ utente_id: utente_cf })
  })
