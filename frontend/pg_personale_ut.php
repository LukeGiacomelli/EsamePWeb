...
include(__DIR__ .'/../backend/usertools.php');
...
<head>
  ...
  <?php include(__DIR__ ."/../css/allstyle.html"); ?>
</head>

<body id="page-top">

  <!-- Importo la navbar -->
  <?php include(__DIR__ ."/../frontend/navbar.php"); ?>
  ...
  <?php
    if ($login_type == 'admin') {  // mostra gestione utenti solo se l'utente è un admin
      include(__DIR__ ."/../common/gestione_utenti.php");
    }
  ?>
  <?php include(__DIR__ ."/../frontend/footer.php"); ?>
  
  <script src="/../EsamePWeb/js/alerts.js"></script>
</body>
</html>