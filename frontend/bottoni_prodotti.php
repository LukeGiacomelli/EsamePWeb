<script src="/../EsamePWeb/js/commenti.js"></script>
    ...
    if ($login_type == 'cliente'){
        ...
        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
             <div class="text-center">
                 <button class="btn btn-outline-dark mt-auto me-2" id="'.$id_prodotto.'" onclick="aggiungiAlCarrello(this,\''. $login_cf .'\')" href="#">Aggiungi al carrello</button>
